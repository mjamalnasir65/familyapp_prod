...
(function(){
  ...
  if (nav === 'go') location.href = `/pages/en/chat-expand-partners.html?pid=${encodeURIComponent(pid)}`;
      return;
    }
  ...
  setTimeout(()=>{ location.href = `/pages/en/chat-expand-partners.html?pid=${encodeURIComponent(pid)}`; }, 900);
