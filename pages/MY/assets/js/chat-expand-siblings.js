...
(function(){
  ...
  if (nav === 'go') location.href = `/pages/my/chat-expand-partners.html?pid=${encodeURIComponent(pid)}`;
      return;
    }
  ...
  setTimeout(()=>{ location.href = `/pages/my/chat-expand-partners.html?pid=${encodeURIComponent(pid)}`; }, 900);
